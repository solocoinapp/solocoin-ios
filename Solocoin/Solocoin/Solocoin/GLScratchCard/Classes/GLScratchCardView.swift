...
public class GLScratchCardView: UIView {
    ...
    public var bottomLayerView:UIView? {
        get {
            ...
            if let bgView = newValue {
                ...
                scratchContainerView.bringSubviewToFront(scratchCardImageView)
    ...
    fileprivate func loadViewFromNib() {
        ...
        scratchContainerView.layer.cornerRadius = scratchContainerView.frame.width/20
        scratchContainerView.clipsToBounds = true
        scratchContainerView.layer.masksToBounds = true
    ...
    fileprivate func setupUIComponents() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 3) {
            if !self.isScratchStarted {
                ...
                self.scratchContainerView.bringSubviewToFront(self.swipeBackToView)
            }
        }
    }
