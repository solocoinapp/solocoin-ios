...
class SecondViewController: UIViewController {
    @IBOutlet weak var solocoinImage: UIImageView!
       ...
       func setLayout(){
           /*solocoinImage.topAnchor.constraint(equalTo: view.topAnchor, constant: view.frame.height/50).isActive = true
           ...
           /*mainpic.topAnchor.constraint(equalTo: solocoinImage.bottomAnchor, constant: 15).isActive = true
           ...
           infoText.topAnchor.constraint(equalTo: mainpic.bottomAnchor, constant: 15).isActive = true
           ...
           nextButton.topAnchor.constraint(equalTo: infoText.bottomAnchor, constant: 25).isActive = true
           ...
           nextButton.heightAnchor.constraint(equalToConstant: mainpic.frame.height/5).isActive = true
           //skip.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -8).isActive = true
           ...
           //skip.centerYAnchor.constraint(equalTo: nextButton.centerYAnchor).isActive = true*/
